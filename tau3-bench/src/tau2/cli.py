...
def add_run_args(parser):
    ...
    parser.add_argument(
        ...
        help=(
            "The LLM used to judge natural-language assertions. "
    ...
    parser.add_argument(
        ...
        type=json.loads,
        default=DEFAULT_LLM_NL_ASSERTIONS_ARGS.copy(),
        help=(
            "JSON arguments passed to the natural-language assertion judge. "
            f"Default is {json.dumps(DEFAULT_LLM_NL_ASSERTIONS_ARGS)}."
        ),
    )
    parser.add_argument(
        "--task-set-name",
...
def main():
    ...
    def run_command(args):
        ...
        set_nl_assertion_llm_config(
            args.nl_assertion_llm,
            args.nl_assertion_llm_args,
        )
