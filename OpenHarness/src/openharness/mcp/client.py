...
class McpClientManager:
    ...
    async def close(self) -> None:
        ...
        # stdio/http transports enter AnyIO cancel scopes in the caller task.
        # They therefore have to be unwound globally in LIFO order.  Closing
        # multiple independently stored stacks in insertion order can cancel
        # the caller and poison every subsequent MCP connection attempt.
